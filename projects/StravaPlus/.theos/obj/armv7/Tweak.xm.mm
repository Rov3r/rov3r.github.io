...
@class STRVAnnualGoalTableViewCell; @class Athlete; @class STRVFeedProgressGoalsCollectionViewCell; @class StravaPremiumFeatureGatekeeper; @class STRVWorkoutViewController; @class StravaPremiumManager; @class User; @class ANSMetadata; @class STRVPremiumCheckoutLaunchController; @class FeedProgressGoalsTableViewCell; @class SettingsTableViewController; @class STRVPremiumAnalytics; 

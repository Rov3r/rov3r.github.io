...
static bool _logos_method$_ungrouped$StravaPremiumFeatureGatekeeper$hasFullAccess(_LOGOS_SELF_TYPE_NORMAL StravaPremiumFeatureGatekeeper* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    return 1;
}



static bool _logos_method$_ungrouped$StravaPremiumFeatureGatekeeper$hasAccess$(_LOGOS_SELF_TYPE_NORMAL StravaPremiumFeatureGatekeeper* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, long long arg1) {
    return 1;
}
